...
<form id="write_form" onsubmit="return BDwrite();">
			...
			<tr>
				...
				<td>
					<table class="table2">
						...
						<tr>
							<td>비밀번호</td>
							<td><input type="text" id="pwd" name="pwd" size="10" maxlength="10" ></td>
						</tr>	
					</table>	
				</td>
	</table>	
						<center>
						<div style="padding-bottom:50px;"><button type="button" onclick="BDwrite();">저장</button></div>
						</center>			
</form>
