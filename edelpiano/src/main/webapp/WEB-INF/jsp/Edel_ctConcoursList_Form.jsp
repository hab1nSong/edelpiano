...
<head>
<meta charset="utf-8">
<title>Edel Concours List</title>
<style>
	.header {
        padding: 0px;
        text-align: center;
...
<ul class="myMenu">
    <li class="menu1">
        ...
        <ul class="menu1_s submenu">
            <li><a href="/notice/list">news</a></li>
...
<div class="body">
<h2 class="contents_h2">Concours</h2>
	<c:forEach var="video" items="${list}">
		<div class="grid">
			<iframe width="200" height="150" frameborder="0"
					...
					<a href="/concours/detail/${video.video_num}">
		...
		<div id="write_btn">
			<a href="/concours/ccWrite"><button type="button">영상업로드</button></a>
		</div>
</div>
