...
<head>
<meta charset="utf-8">
<title>이델피아노 오시는 길</title>
<style>

	
	.edelpiano {padding-top:10px; text-align:center;}
	
	a{style:none; text-decoration:none; font-color:black; color:black; }
...
<table  style="padding-top:20px" align = center width=830 border=0 cellpadding=2 >
			<tr>
				<td height=20 align=center bgcolor=#c0c0c0>
					<font color=white>오시는길</font>
				</td>
			</tr>
</table>			
...
<!-- * 카카오맵 - 지도퍼가기 -->
<!-- 1. 지도 노드 -->
<div id="daumRoughmapContainer1642755216602" class="root_daum_roughmap root_daum_roughmap_landing"></div>
