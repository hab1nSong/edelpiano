...
<script>
	function replyno(){
		...
		var serData = $('#replyno_form').serialize();
		console.log(serData);
		$.ajax({
			url:'/replywrite',
			method:'post',
...
<!-- header 여기까지 입니다. -->
	...
	<div>
		<center>
		<textarea id="target-textarea" cols="56" readonly>${n.content}</textarea>
		<div style="padding-top: 30px;"><img src="../../Edel/${n.nj_url}" onError="this.style.visibility='hidden'" width="500" height="700"></div>
		</center>
	</div>
	...
	<form id="replyno_form" onsubmit="return replyno();">
	<table  style="padding-top:0px" align = center width=700 border=0 cellpadding=2 >
		<tr>
	...
	<table  style="padding-top:0px" align = center width=700 border=0 cellpadding=2 >
		...
		<div style="padding-bottom:30px;">
			<center>
			<button type="submit"><a href="/notice/list">목록</a></button>
			<button type="button"><a href="/notice/update/${n.num}">수정</a></button>
			</center>
		</div>
