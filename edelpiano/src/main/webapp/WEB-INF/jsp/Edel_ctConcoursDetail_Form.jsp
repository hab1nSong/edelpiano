...
<head>
<meta charset="utf-8">
<title>Edel Concours Detail</title>
<script>
	function del(num){
		var reqURL = '/concours/delete/'+num;
...
<ul class="myMenu">
    ...
    <li class="menu5">
		...
		<table  style="padding-top:30px" align = center width=703 border=0 cellpadding=2 >
			<tr>
		...
		<iframe width="700" height="450" frameborder="0"
			...
			<tr>
				<td class="button" height=20 align=right>
					<a href="/concours/list"><button type="button">목록</button></a> 
